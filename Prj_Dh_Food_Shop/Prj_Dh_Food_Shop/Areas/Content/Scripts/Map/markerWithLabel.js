...
function MarkerLabel_(marker, crossURL, handCursorURL) {
  ...
  this.getPanes().appendChild(this.labelDiv_);
  this.getPanes().appendDOM(this.eventDiv_);
  // One cross is shared with all markers, so only add it once:
  if (typeof MarkerLabel_.getSharedCross.processed === "undefined") {
    this.getPanes().appendChild(this.crossDiv_);
 ...
 */
LabelMarker.prototype = new viettel.Marker();
LabelMarker.prototype.constructor = LabelMarker
function LabelMarker(opt_options) {
 ...
 * @private
 */
/*LabelMarker.prototype.setMap = function (theMap) {
  // Call the inherited function...
  //Marker.prototype.setMap.apply(this, arguments);
